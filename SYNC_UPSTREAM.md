...
[![Sync with Upstream](https://img.shields.io/badge/Sync%20with-Upstream-blue?style=for-the-badge&logo=github)](https://github.com/lacymorrow/delete-62/compare/main...lacymorrow:shipkit:main)
...
```bash
gh repo sync lacymorrow/delete-62 --source lacymorrow/shipkit
```
...
2. Click "Compare" or go to: https://github.com/lacymorrow/delete-62/compare/main...lacymorrow:shipkit:main
